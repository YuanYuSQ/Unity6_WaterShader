    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            half4 frag (Varyings input) : SV_Target
            {
                ...
                half3 rawProbe = probeColor;          // 保存原始探头颜色，供泛光使用（不受 _ProbeIntensity 影响）
                ...
                half3 envGlowColor = rawProbe;        // 使用原始探头颜色，不受 _ProbeIntensity 缩放影响
                ...
                // 轨道 A：Glint 碎斑高光 —— 加入掠角 Fresnel 衰减，正上方看水面时削弱碎斑
                ...
                // 轨道 B：GGX 镜面高光 —— 乘以 NdotL 确保受光面才有高光
